...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team that plays interscholastic matches",
    ...
    "Robotics Club": {
        ...
        "schedule": "Tuesdays, Thursdays, 3:30 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "nova@mergington.edu"]
    }
}
